      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            children: [
              SizedBox(height: 20),
              _returnTextField(_bankName, 'Enter Bank Name'),
              SizedBox(height: 20),
              _returnTextField(_amtDeposited, 'Enter Amount Deposited'),
              SizedBox(height: 20),
              _returnTextField(_interestRate, 'Enter Interest Rate'),
              SizedBox(height: 20),
              _returnTextField(_investDate, 'Enter Invested Date'),
              SizedBox(height: 20),
              _returnTextField(_maturityDate, 'Enter Maturity Date'),
              SizedBox(height: 20),
