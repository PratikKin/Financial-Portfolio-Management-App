...
import 'package:mone_age/Backend/Main%20Stocks/BuySellStocks.dart';

void showBuyStocks(
    BuildContext ctx, String name, String sym, double currentPrice) {
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: Center(
          child: GestureDetector(
            onTap: () async {
              bool success = await buyStock(
                  widget.name, widget.sym, widget.currentPrice, buy_quantity);
              if (success == true) {
                Navigator.pop(context);
              } else {
                print("Unable to buy!");
